...
dotnet build src\AutoVersionsDB\AutoVersionsDB.Core\AutoVersionsDB.Core.csproj -c debug 2>> "%errorsLogFile%"
...
dotnet build src\AutoVersionsDB\AutoVersionsDB.WinApp\AutoVersionsDB.WinApp.csproj -c debug 2>> "%errorsLogFile%"
CALL :checkError "%errorsLogFile%"
