...
{
    public class DevEnv_Files_IncrementalChanged_Incremental_CLI : TestDefinition<CLITestContext>
    {

        private readonly DevEnv_Files_IncrementalChanged_API _files_IncrementalChanged_API;

        public DevEnv_Files_IncrementalChanged_Incremental_CLI(DevEnv_Files_IncrementalChanged_API devEnv_Files_IncrementalChanged_API)
        {
