...
{
    public class DevEnv_Files_All_IncrementalChanged_CLI : TestDefinition<DBVersionsTestContext>
    {

        private readonly DevEnv_Files_IncrementalChanged_API _devEnv_Files_IncrementalChanged_API;

        public DevEnv_Files_All_IncrementalChanged_CLI(DevEnv_Files_IncrementalChanged_API devEnv_Files_IncrementalChanged_API)
        {
