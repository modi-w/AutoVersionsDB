...
{
    public class DevEnv_Validate_HistoryExecutedFilesMissing_UI : TestDefinition<DBVersionsAPITestContext>
    {
        private readonly DevEnv_Validate_HistoryExecutedFilesMissing_API _devEnv_Validate_HistoryExecutedFilesMissing_API;
        private readonly DBVersionsViewModel _dbVersionsViewModel;
        private readonly DBVersionsViewModelAsserts _dbVersionsViewModelAsserts;

        public DevEnv_Validate_HistoryExecutedFilesMissing_UI(DevEnv_Validate_HistoryExecutedFilesMissing_API devEnv_Validate_HistoryExecutedFilesMissing_API,
