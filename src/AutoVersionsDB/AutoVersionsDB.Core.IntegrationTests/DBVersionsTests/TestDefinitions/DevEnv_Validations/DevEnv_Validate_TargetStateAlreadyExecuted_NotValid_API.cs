...
namespace AutoVersionsDB.Core.IntegrationTests.DBVersionsTests.TestDefinitions.DevEnv_Validations
{
    public class DevEnv_Validate_TargetStateAlreadyExecuted_NotValid_API : TestDefinition
    {
        ...
        {
            testContext.ProcessResults = AutoVersionsDBAPI.ValdiateTargetStateAlreadyExecuted(testContext.ProjectConfig.Id, IntegrationTestsConsts.MiddleStateTargetScripts.IncScriptFileName, null);
        }
        ...
        public override void Asserts(ITestContext testContext)
        {
            ...
            _processAsserts.AssertContainError(this.GetType().Name, testContext.ProcessResults.Trace, TargetScriptFiletAlreadyExecutedValidator.Name);
