...
{
    public class DevEnv_Validate_NewProject_UI : TestDefinition<DBVersionsUITestContext>
    {
        private readonly DevEnv_Validate_NewProject_API _devEnv_Validate_NewProject_API;
        private readonly DBVersionsViewModel _dbVersionsViewModel;
        private readonly DBVersionsViewModelAsserts _dbVersionsViewModelAsserts;

        public DevEnv_Validate_NewProject_UI(DevEnv_Validate_NewProject_API devEnv_Validate_NewProject_API,
        ...
        {
            DBVersionsUITestContext testContext = new DBVersionsUITestContext(_devEnv_Validate_NewProject_API.Arrange(testArgs));
