...
{
    public class DevEnv_Validate_MissingSystemTables_API : TestDefinition
    {
        private readonly ProjectConfigWithDBArrangeAndAssert _projectConfigWithDBArrangeAndAssert;
        private readonly ProcessAsserts _processAsserts;

        public DevEnv_Validate_MissingSystemTables_API(ProjectConfigWithDBArrangeAndAssert projectConfigWithDBArrangeAndAssert,
        ...
        {
            return _projectConfigWithDBArrangeAndAssert.Arrange(testArgs, true, DBBackupFileType.FinalState_MissingSystemTables, ScriptFilesStateType.ValidScripts);
        }
