...
{
    public class DevEnv_Validate_HistoryExecutedFilesChanged_API : ITestDefinition
    {
        private readonly DBVersionsNotValidTest _dbVersionsNotValidTest;
        private readonly ProcessAsserts _processAsserts;

        public DevEnv_Validate_HistoryExecutedFilesChanged_API(DBVersionsNotValidTest dbVersionsNotValidTest, 
