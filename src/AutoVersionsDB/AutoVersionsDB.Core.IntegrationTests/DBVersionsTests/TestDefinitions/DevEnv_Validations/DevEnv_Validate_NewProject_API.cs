...
{
    public class DevEnv_Validate_NewProject_API : TestDefinition
    {
        private readonly ProjectConfigWithDBArrangeAndAssert _projectConfigWithDBArrangeAndAssert;
        private readonly ProcessAsserts _processAsserts;

        public DevEnv_Validate_NewProject_API(ProjectConfigWithDBArrangeAndAssert projectConfigWithDBArrangeAndAssert,
