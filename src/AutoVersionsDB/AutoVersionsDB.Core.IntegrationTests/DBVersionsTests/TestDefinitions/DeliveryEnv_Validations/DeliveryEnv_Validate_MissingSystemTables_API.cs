...
{
    public class DeliveryEnv_Validate_MissingSystemTables_API : TestDefinition
    {
        private readonly ProjectConfigWithDBArrangeAndAssert _projectConfigWithDBArrangeAndAssert;
        private readonly ProcessAsserts _processAsserts;

        public DeliveryEnv_Validate_MissingSystemTables_API(ProjectConfigWithDBArrangeAndAssert projectConfigWithDBArrangeAndAssert,
        ...
        {
            return _projectConfigWithDBArrangeAndAssert.Arrange(testArgs, false, DBBackupFileType.FinalState_MissingSystemTables, ScriptFilesStateType.ValidScripts);
        }
        ...
        public override void Asserts(ITestContext testContext)
        {
            ...
            _processAsserts.AssertContainError(this.GetType().Name, testContext.ProcessResults.Trace, SystemTablesValidator.Name);
