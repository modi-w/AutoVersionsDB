...
{
    public class DeliveryEnv_Validate_HistoryExecutedFilesChanged_API : ITestDefinition
    {
        private readonly DBVersionsNotValidTest _dbVersionsNotValidTest;
        private readonly ProcessAsserts _processAsserts;

        public DeliveryEnv_Validate_HistoryExecutedFilesChanged_API(DBVersionsNotValidTest dbVersionsNotValidTest, 
