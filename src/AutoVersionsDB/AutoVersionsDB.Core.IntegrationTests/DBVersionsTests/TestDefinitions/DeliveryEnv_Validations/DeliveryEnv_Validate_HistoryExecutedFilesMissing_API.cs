...
{
    public class DeliveryEnv_Validate_HistoryExecutedFilesMissing_API : TestDefinition
    {
        private readonly ProjectConfigWithDBArrangeAndAssert _projectConfigWithDBArrangeAndAssert;
        private readonly ProcessAsserts _processAsserts;

        public DeliveryEnv_Validate_HistoryExecutedFilesMissing_API(ProjectConfigWithDBArrangeAndAssert projectConfigWithDBArrangeAndAssert,
        ...
        {
            return _projectConfigWithDBArrangeAndAssert.Arrange(testArgs, false, DBBackupFileType.FinalState_DeliveryEnv, ScriptFilesStateType.MissingFile);
        }
