...
{
    public class DevEnv_SyncDB_RepeatableChanged_API : TestDefinition<DBVersionsAPITestContext>
    {
        private readonly ProjectConfigWithDBArrangeAndAssert _dbVersionsTestHelper;
        private readonly ScriptFilesAsserts _scriptFilesAsserts;
        private readonly DBAsserts _dbAsserts;

        public DevEnv_SyncDB_RepeatableChanged_API(ProjectConfigWithDBArrangeAndAssert dbVersionsTestHelper,
