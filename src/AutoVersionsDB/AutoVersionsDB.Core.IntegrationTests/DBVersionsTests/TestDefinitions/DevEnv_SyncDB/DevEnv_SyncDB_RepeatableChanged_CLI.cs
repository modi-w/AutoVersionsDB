...
{
    public class DevEnv_SyncDB_RepeatableChanged_CLI : ITestDefinition
    {
        ...
        {
            TestContext testContext = _devEnv_SyncDB_RepeatableChanged_API.Arrange(projectConfig, dbBackupFileType, scriptFilesStateType);
