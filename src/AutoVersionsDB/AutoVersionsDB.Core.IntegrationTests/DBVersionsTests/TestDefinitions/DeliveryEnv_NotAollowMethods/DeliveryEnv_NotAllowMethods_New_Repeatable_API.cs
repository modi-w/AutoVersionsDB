...
{
    public class DeliveryEnv_NotAllowMethods_New_Repeatable_API : TestDefinition<DBVersionsTestContext>
    {
        ...
        public DeliveryEnv_NotAllowMethods_New_Repeatable_API(DBVersionsTestHelper dbVersionsTestHelper,
