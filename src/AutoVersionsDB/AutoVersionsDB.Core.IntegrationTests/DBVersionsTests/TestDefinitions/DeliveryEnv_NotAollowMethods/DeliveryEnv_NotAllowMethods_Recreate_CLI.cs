...
{
    public class DeliveryEnv_NotAllowMethods_Recreate_CLI : TestDefinition<CLITestContext>
    {
        ...
        {
            CLITestContext testContext = new CLITestContext(_deliveryEnv_NotAllowMethods_Recreate_API.Arrange(testArgs));
