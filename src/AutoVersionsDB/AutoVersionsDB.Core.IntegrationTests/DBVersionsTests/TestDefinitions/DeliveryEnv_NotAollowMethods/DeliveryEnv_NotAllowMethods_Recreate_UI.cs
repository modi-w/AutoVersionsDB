...
{
    public class DeliveryEnv_NotAllowMethods_Recreate_UI : TestDefinition<DBVersionsAPITestContext>
    {
        ...
        {
            DBVersionsAPITestContext testContext = _devEnv_NotAllowMethods_Recreate_API.Arrange(testArgs) as DBVersionsAPITestContext;
