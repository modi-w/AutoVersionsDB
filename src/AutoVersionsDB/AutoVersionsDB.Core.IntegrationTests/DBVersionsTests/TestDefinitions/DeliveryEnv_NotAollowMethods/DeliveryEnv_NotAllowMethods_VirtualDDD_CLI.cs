...
{
    public class DeliveryEnv_NotAllowMethods_VirtualDDD_CLI : TestDefinition<CLITestContext>
    {

        private readonly DeliveryEnv_NotAllowMethods_VirtualDDD_API _deliveryEnv_NotAllowMethods_VirtualDDD_API;

        public DeliveryEnv_NotAllowMethods_VirtualDDD_CLI(DeliveryEnv_NotAllowMethods_VirtualDDD_API deliveryEnv_NotAllowMethods_VirtualDDD_API)
        {
            _deliveryEnv_NotAllowMethods_VirtualDDD_API = deliveryEnv_NotAllowMethods_VirtualDDD_API;
        }

        public override ITestContext Arrange(TestArgs testArgs)
        {
            CLITestContext testContext = new CLITestContext(_deliveryEnv_NotAllowMethods_VirtualDDD_API.Arrange(testArgs));
        ...
        {
            _deliveryEnv_NotAllowMethods_VirtualDDD_API.Asserts(testContext);
            ...
            assertConsoleOutTextByLines.AssertLineMessage(CLITextResources.StartProcessMessageWithArgs.Replace("[processName]", "vrddd").Replace("[args]", "IntegrationTestProject"), true);
        ...
        {
            _deliveryEnv_NotAllowMethods_VirtualDDD_API.Release(testContext);
        }
