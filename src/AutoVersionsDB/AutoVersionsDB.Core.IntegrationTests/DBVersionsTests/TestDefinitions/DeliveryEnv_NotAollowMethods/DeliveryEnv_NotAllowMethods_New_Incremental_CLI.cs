...
{
    public class DeliveryEnv_NotAllowMethods_New_Incremental_CLI : TestDefinition<DBVersionsAPITestContext>
    {
        ...
        {
            TestContext testContext = _deliveryEnv_New_Incremental_API.Arrange(testArgs);
