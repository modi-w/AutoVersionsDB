...
{
    public class DeliveryEnv_NotAllowMethods_New_DevDummyData_UI : TestDefinition<DBVersionsAPITestContext>
    {
        ...
        {
            DBVersionsAPITestContext testContext = _devEnv_NotAllowMethods_New_DevDummyData_API.Arrange(testArgs) as DBVersionsAPITestContext;
