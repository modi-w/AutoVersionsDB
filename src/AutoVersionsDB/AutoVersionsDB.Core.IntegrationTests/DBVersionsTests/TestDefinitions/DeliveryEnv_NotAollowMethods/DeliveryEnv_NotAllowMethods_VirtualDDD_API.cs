...
{
    public class DeliveryEnv_NotAllowMethods_VirtualDDD_API : TestDefinition
    {
        private readonly ProjectConfigWithDBArrangeAndAssert _projectConfigWithDBArrangeAndAssert;
        private readonly ProcessAsserts _processAsserts;

        public DeliveryEnv_NotAllowMethods_VirtualDDD_API(ProjectConfigWithDBArrangeAndAssert projectConfigWithDBArrangeAndAssert,
