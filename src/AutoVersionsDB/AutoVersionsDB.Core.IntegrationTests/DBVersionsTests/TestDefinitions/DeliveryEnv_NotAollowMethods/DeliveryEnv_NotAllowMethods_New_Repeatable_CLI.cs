...
{
    public class DeliveryEnv_NotAllowMethods_New_Repeatable_CLI : TestDefinition<DBVersionsAPITestContext>
    {
        ...
        {
            TestContext testContext = _deliveryEnv_New_Repeatable_API.Arrange(testArgs);
