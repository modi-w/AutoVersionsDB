...
{
    public class DeliveryEnv_NotAllowMethods_New_Repeatable_CLI : TestDefinition<CLITestContext>
    {

        private readonly DeliveryEnv_NotAllowMethods_New_Repeatable_API _deliveryEnv_New_Repeatable_API;

        public DeliveryEnv_NotAllowMethods_New_Repeatable_CLI(DeliveryEnv_NotAllowMethods_New_Repeatable_API deliveryEnv_New_Repeatable_API)
        {
            _deliveryEnv_New_Repeatable_API = deliveryEnv_New_Repeatable_API;
        }

        public override ITestContext Arrange(TestArgs testArgs)
        {
            CLITestContext testContext = new CLITestContext(_deliveryEnv_New_Repeatable_API.Arrange(testArgs));
        ...
        public override void Asserts(CLITestContext testContext)
        {
            ...
            assertConsoleOutTextByLines.AssertLineMessage(CLITextResources.StartProcessMessageWithArgs.Replace("[processName]", "new repeatable").Replace("[args]", "IntegrationTestProject"), true);
        ...
        {
            _deliveryEnv_New_Repeatable_API.Release(testContext);
        }
