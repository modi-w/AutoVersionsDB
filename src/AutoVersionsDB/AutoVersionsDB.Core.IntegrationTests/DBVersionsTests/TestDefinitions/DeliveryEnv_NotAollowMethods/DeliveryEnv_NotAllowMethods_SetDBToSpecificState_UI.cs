...
{
    public class DeliveryEnv_NotAllowMethods_SetDBToSpecificState_UI : TestDefinition<DBVersionsUITestContext>
    {
        ...
        {
            DBVersionsUITestContext testContext = new DBVersionsUITestContext(_devEnv_NotAllowMethods_SetDBToSpecificState_API.Arrange(testArgs));
