...
{
    public class DevEnv_Virtual_EmptyDB_API  : TestDefinition<DBVersionsAPITestContext>
    {
        private readonly ProjectConfigWithDBArrangeAndAssert _dbVersionsTestHelper;
        private readonly ScriptFilesAsserts _scriptFilesAsserts;
        private readonly DBAsserts _dbAsserts;

        public DevEnv_Virtual_EmptyDB_API(ProjectConfigWithDBArrangeAndAssert dbVersionsTestHelper,
