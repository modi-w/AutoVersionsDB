...
{
    public class DevEnv_Virtual_EmptyDBWithSystemTables_API  : TestDefinition<DBVersionsAPITestContext>
    {
        private readonly DBVersionsTestHelper _dbVersionsTestHelper;
        private readonly ScriptFilesAsserts _scriptFilesAsserts;
        private readonly DBAsserts _dbAsserts;

        public DevEnv_Virtual_EmptyDBWithSystemTables_API(DBVersionsTestHelper dbVersionsTestHelper,
