...
namespace AutoVersionsDB.Core.IntegrationTests.DBVersionsTests.TestDefinitions.DevEnv_Virtual
{
    public class DevEnv_Virtual_EmptyDBWithSystemTables_API : TestDefinition
    {
        ...
        public DevEnv_Virtual_EmptyDBWithSystemTables_API(ProjectConfigWithDBArrangeAndAssert projectConfigWithDBArrangeAndAssert,
        ...
        {
            return _projectConfigWithDBArrangeAndAssert.Arrange(testArgs, true, DBBackupFileType.EmptyDBWithSystemTables, ScriptFilesStateType.ValidScripts);
        }
