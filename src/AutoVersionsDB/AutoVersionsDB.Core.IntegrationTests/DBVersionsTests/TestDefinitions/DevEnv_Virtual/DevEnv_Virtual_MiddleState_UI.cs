...
{
    public class DevEnv_Virtual_MiddleState_UI : TestDefinition<DBVersionsUITestContext>
    {
        private readonly DevEnv_Virtual_MiddleState_API _deliveryEnv_Virtual_API;
        private readonly DBVersionsViewModel _dbVersionsViewModel;
        private readonly DBVersionsViewModelAsserts _dbVersionsViewModelAsserts;

        public DevEnv_Virtual_MiddleState_UI(DevEnv_Virtual_MiddleState_API deliveryEnv_Virtual_API,
        ...
        public override void Asserts(DBVersionsUITestContext testContext)
        {
            ...
            _dbVersionsViewModelAsserts.AssertCompleteSuccessfullyAllFilesSyncVirtual(this.GetType().Name, _dbVersionsViewModel, testContext.ProjectConfig.DevEnvironment);
