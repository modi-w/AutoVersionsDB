...
{
    public class DevEnv_Virtual_EmptyDBWithSystemTables_CLI : TestDefinition<CLITestContext>
    {

        private readonly DevEnv_Virtual_EmptyDBWithSystemTables_API _deliveryEnv_Virtual_API;

        public DevEnv_Virtual_EmptyDBWithSystemTables_CLI(DevEnv_Virtual_EmptyDBWithSystemTables_API deliveryEnv_Virtual_API)
        {
        ...
        {
            CLIRunner.CLIRun($"virtual -id={IntegrationTestsConsts.TestProjectId} -t={IntegrationTestsConsts.TargetStateFile_MiddleState}");
        }
