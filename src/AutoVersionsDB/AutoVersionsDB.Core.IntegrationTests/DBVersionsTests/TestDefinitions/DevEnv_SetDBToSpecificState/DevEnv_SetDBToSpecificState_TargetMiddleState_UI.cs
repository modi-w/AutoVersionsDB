...
{
    public class DevEnv_SetDBToSpecificState_TargetMiddleState_UI : TestDefinition<DBVersionsUITestContext>
    {
        ...
        public DevEnv_SetDBToSpecificState_TargetMiddleState_UI(DevEnv_SetDBToSpecificState_TargetMiddleState_API devEnv_SetDBToSpecificState_TargetMiddleState_API,
                                                        DBVersionsViewModel dbVersionsViewModel,
                                                        DBVersionsViewModelAsserts dbVersionsViewModelAsserts)
        {
            _devEnv_SetDBToSpecificState_TargetMiddleState_API = devEnv_SetDBToSpecificState_TargetMiddleState_API;
        ...
        {
            DBVersionsUITestContext testContext = new DBVersionsUITestContext(_devEnv_SetDBToSpecificState_TargetMiddleState_API.Arrange(testArgs));
        ...
        public override void Release(DBVersionsUITestContext testContext)
        {
            ...
            _devEnv_SetDBToSpecificState_TargetMiddleState_API.Release(testContext);
        }
