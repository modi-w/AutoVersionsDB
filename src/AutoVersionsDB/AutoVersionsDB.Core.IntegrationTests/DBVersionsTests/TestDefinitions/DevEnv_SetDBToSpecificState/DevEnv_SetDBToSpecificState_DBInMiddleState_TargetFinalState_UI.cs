...
{
    public class DevEnv_SetDBToSpecificState_DBInMiddleState_TargetFinalState_UI : TestDefinition<DBVersionsUITestContext>
    {
        ...
        {
            DBVersionsUITestContext testContext = new DBVersionsUITestContext(_devEnv_SetDBToSpecificState_DBInMiddleState_TargetFinalState_API.Arrange(testArgs));
