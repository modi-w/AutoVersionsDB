...
{
    public class DevEnv_SetDBToSpecificState_IgnoreWarning_API : ITestDefinition
    {
        private readonly DBVersionsValidTest _dbVersionsValidTest;
        private readonly ScriptFilesAsserts _scriptFilesAsserts;
        private readonly DBAsserts _dbAsserts;

        public DevEnv_SetDBToSpecificState_IgnoreWarning_API(DBVersionsValidTest dbVersionsValidTest,
