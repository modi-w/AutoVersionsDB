...
{
    public class DevEnv_SetDBToSpecificState_IgnoreWarning_UI : TestDefinition<DBVersionsTestContext>
    {
        ...
        {
            DBVersionsTestContext testContext = _devEnv_SetDBToSpecificState_IgnoreWarning_API.Arrange(testArgs) as DBVersionsTestContext;
