...
{
    public class DevEnv_NewScrtiptFile_Repeatable_UI : TestDefinition<DBVersionsTestContext>
    {
        ...
        {
            DBVersionsTestContext testContext = _devEnv_NewScrtiptFile_Repeatable_API.Arrange(testArgs) as DBVersionsTestContext;
