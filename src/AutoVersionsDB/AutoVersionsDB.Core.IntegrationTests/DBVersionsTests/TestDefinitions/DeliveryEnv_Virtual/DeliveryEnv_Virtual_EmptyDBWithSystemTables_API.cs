...
{
    public class DeliveryEnv_Virtual_EmptyDBWithSystemTables_API  : TestDefinition<DBVersionsAPITestContext>
    {
        private readonly ProjectConfigWithDBArrangeAndAssert _dbVersionsTestHelper;
        private readonly ScriptFilesAsserts _scriptFilesAsserts;
        private readonly DBAsserts _dbAsserts;

        public DeliveryEnv_Virtual_EmptyDBWithSystemTables_API(ProjectConfigWithDBArrangeAndAssert dbVersionsTestHelper,
