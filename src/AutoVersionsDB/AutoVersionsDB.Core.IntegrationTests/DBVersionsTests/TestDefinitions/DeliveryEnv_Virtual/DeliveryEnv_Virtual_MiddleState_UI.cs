...
{
    public class DeliveryEnv_Virtual_MiddleState_UI : TestDefinition<DBVersionsUITestContext>
    {
        private readonly DeliveryEnv_Virtual_MiddleState_API _deliveryEnv_Virtual_API;
        private readonly DBVersionsViewModel _dbVersionsViewModel;
        private readonly DBVersionsViewModelAsserts _dbVersionsViewModelAsserts;

        public DeliveryEnv_Virtual_MiddleState_UI(DeliveryEnv_Virtual_MiddleState_API deliveryEnv_Virtual_API,
