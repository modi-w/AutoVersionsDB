...
{
    public class DeliveryEnv_Virtual_EmptyDB_UI : TestDefinition<DBVersionsAPITestContext>
    {
        private readonly DeliveryEnv_Virtual_EmptyDB_API _devEnv_Virtual_API;
        private readonly DBVersionsViewModel _dbVersionsViewModel;
        private readonly DBVersionsViewModelAsserts _dbVersionsViewModelAsserts;

        public DeliveryEnv_Virtual_EmptyDB_UI(DeliveryEnv_Virtual_EmptyDB_API devEnv_Virtual_API,
