...
{
    public class DevEnv_Restore_SyncDB_UI : TestDefinition<DBVersionsAPITestContext>
    {
        ...
        {
            DBVersionsAPITestContext testContext = _devEnv_Restore_SyncDB_API.Arrange(testArgs) as DBVersionsAPITestContext;
