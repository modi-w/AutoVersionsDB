...
{
    public class DevEnv_Restore_SyncDB_API : TestDefinition<DBVersionsAPITestContext>
    {
        private readonly ProjectConfigWithDBArrangeAndAssert _dbVersionsTestHelper;
        private readonly DBAsserts _dbAsserts;

        public DevEnv_Restore_SyncDB_API(ProjectConfigWithDBArrangeAndAssert dbVersionsTestHelper,
                                        DBAsserts dbAsserts)
        {
