...
{
    public class DevEnv_Restore_SyncDB_API : TestDefinition
    {
        private readonly ProjectConfigWithDBArrangeAndAssert _projectConfigWithDBArrangeAndAssert;
        private readonly DBAsserts _dbAsserts;

        public DevEnv_Restore_SyncDB_API(ProjectConfigWithDBArrangeAndAssert projectConfigWithDBArrangeAndAssert,
                                        DBAsserts dbAsserts)
        {
