...
{
    public class DevEnv_Restore_SyncDB_CLI : ITestDefinition
    {
        ...
        {
            TestContext testContext = _devEnv_Restore_SyncDB_API.Arrange(projectConfig, dbBackupFileType, scriptFilesStateType);
