...
namespace AutoVersionsDB.Core.IntegrationTests
{
    public static class IntegrationTestsSetting
    {
        ...
        public const string  SQLServer_ConnStr  = @"Data Source=(localdb)\localtestdb; Database=AutoVersionsDB.Tests; Trusted_Connection=True;";
        public const string  SQLServer_ConnStrToMaster  = @"Data Source=(localdb)\localtestdb; Database=Master; Trusted_Connection=True;";
