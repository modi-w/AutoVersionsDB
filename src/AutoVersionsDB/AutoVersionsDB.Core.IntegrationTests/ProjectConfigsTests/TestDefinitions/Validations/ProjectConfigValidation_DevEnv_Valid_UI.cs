...
{
    public class ProjectConfigValidation_DevEnv_Valid_UI : TestDefinition<EditProjectUITestContext>
    {
        private readonly ProjectConfigValidation_DevEnv_Valid_API _projectConfigValidation_DevEnv_Valid_API;
        ...
        public ProjectConfigValidation_DevEnv_Valid_UI(ProjectConfigValidation_DevEnv_Valid_API projectConfigValidation_DevEnv_Valid_API,
        ...
        {
            _projectConfigValidation_DevEnv_Valid_API = projectConfigValidation_DevEnv_Valid_API;
        ...
        {
            EditProjectUITestContext testContext = new EditProjectUITestContext(_projectConfigValidation_DevEnv_Valid_API.Arrange(testArgs));
        ...
        {
            _projectConfigValidation_DevEnv_Valid_API.Asserts(testContext);
        ...
        {
            _projectConfigValidation_DevEnv_Valid_API.Release(testContext);
