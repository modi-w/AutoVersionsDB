...
{
    public class ProjectConfigValidation_DeliveryEnv_Valid_UI : TestDefinition<EditProjectUITestContext>
    {
        private readonly ProjectConfigValidation_DeliveryEnv_Valid_API _projectConfigValidation_DeliveryEnv_Valid_API;
        ...
        {
            EditProjectUITestContext testContext = new EditProjectUITestContext(_projectConfigValidation_DeliveryEnv_Valid_API.Arrange(testArgs));
        ...
        {
            _projectConfigValidation_DeliveryEnv_Valid_API.Asserts(testContext);
        ...
        {
            _projectConfigValidation_DeliveryEnv_Valid_API.Release(testContext);
