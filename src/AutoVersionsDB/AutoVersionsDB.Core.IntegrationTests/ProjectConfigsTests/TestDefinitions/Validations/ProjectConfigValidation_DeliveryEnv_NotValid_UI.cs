...
{
    public class ProjectConfigValidation_DeliveryEnv_NotValid_UI : TestDefinition<EditProjectUITestContext>
    {
        private readonly ProjectConfigValidation_DeliveryEnv_NotValid_API _projectConfigValidation_DeliveryEnv_NotValid_API;
        ...
        public ProjectConfigValidation_DeliveryEnv_NotValid_UI(ProjectConfigValidation_DeliveryEnv_NotValid_API projectConfigValidation_DeliveryEnv_NotValid_API,
        ...
        {
            _projectConfigValidation_DeliveryEnv_NotValid_API = projectConfigValidation_DeliveryEnv_NotValid_API;
        ...
        {
            EditProjectUITestContext testContext = new EditProjectUITestContext(_projectConfigValidation_DeliveryEnv_NotValid_API.Arrange(testArgs));
        ...
        {
            _projectConfigValidation_DeliveryEnv_NotValid_API.Asserts(testContext);
            ...
            _editProjectViewStateAsserts.AssertError(GetType().Name,
                ...
                new List<string>()
                {
                    ...
                    DeliveryArtifactFolderPathValidator.Name,
                }
                );
        ...
        {
            _projectConfigValidation_DeliveryEnv_NotValid_API.Release(testContext);
