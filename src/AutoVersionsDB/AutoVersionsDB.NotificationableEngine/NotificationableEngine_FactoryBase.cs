...
{
    public abstract class NotificationableEngine_FactoryBase
    {
        ...
        public NotificationableEngine_FactoryBase()
        {
    ...
    public abstract class NotificationableEngine_FactoryBase<TNotificationEngine, TNotificationableEngineConfig> : NotificationableEngine_FactoryBase
