...
{
    public class RecreateDBFromScratchEngine_Factory : NotificationableEngine_FactoryBase<AutoVersionsDbEngine, ProjectConfigItem>
    {
        ...
        public RecreateDBFromScratchEngine_Factory(DBCommands_FactoryProvider dbCommands_FactoryProvider,
